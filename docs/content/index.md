...
seo:
  ...
  description: Nuxt Codemirror Module is a module for Nuxt 3 that allows you to use Codemirror in your project.
---
...
---
  :::prose-pre
  ---
  code: npx nuxi module add nuxt-codemirror
  filename: Terminal
  ---
  ```bash
...
#title
Build with the Nuxt Codemirror Module

#description
Nuxt Codemirror Module is a module for Nuxt 3 that allows you to use Codemirror in your project.
